...
$phonenum=$_POST['phonenum'];
  ...
  $query=mysqli_query($con,"update tblpages set PageTitle='$pagetitle', PageDescription='$pagedes',HeadOffice='$headoff',Email='$email',PhoneNumber='$phonenum' where  PageType='contactus'");
...
<head>
  ...
  <title>Contact Us | Technocar Sale System</title>
...
?>
                  <form class="form-validate form-horizontal" method="post" action="">
                    ...
                    <div class="form-group ">
                      <label for="fullname" class="control-label col-lg-2">Head Office <span class="required">*</span></label>
                      <div class="col-lg-10">
                        <input type="text" name="headoff" class=" form-control" required= "true" value="<?php  echo $row['HeadOffice'];?>">
                      </div>
                    </div>
                    <div class="form-group ">
                      ...
                      <div class="col-lg-10">
                        <input type="text" name="phonenum" class=" form-control" required= "true" value="<?php  echo $row['PhoneNumber'];?>">
                      </div>
                    </div>
                    <div class="form-group ">
