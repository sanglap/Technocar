...
$carpic=md5($cpic).$extension;
    ...
    $query=mysqli_query($con, "update tblcars set CarImage4 ='$carpic' where ID='$cid'");
    if ($query) {
...
<head>
  ...
  <title>Update Car Image |Technocar Sale System</title>
...
<body>
  ...
  <?php
 $cid=$_GET['editid'];
$ret=mysqli_query($con,"select CarName,CarImage4 from tblcars where ID='$cid'");
$cnt=1;
...
?>
                  ...
                  <div class="form-group">
                    ...
                    <div class="col-sm-10">
                      <img src="images/<?php echo $row['CarImage4'];?>" width="200" height="150">
                    </div>
                  </div>
                  <div class="form-group">
