...
$carpic=md5($cpic).$extension;
    ...
    $query=mysqli_query($con, "update tblcars set CarImage3 ='$carpic' where ID='$cid'");
    if ($query) {
...
<body>
  ...
  <?php
 $cid=$_GET['editid'];
$ret=mysqli_query($con,"select CarName,CarImage3 from tblcars where ID='$cid'");
$cnt=1;
...
?>
                  ...
                  <div class="form-group">
                    ...
                    <div class="col-sm-10">
                      <img src="images/<?php echo $row['CarImage3'];?>" width="200" height="150">
                    </div>
                  </div>
                  <div class="form-group">
